...
class Board:
    ...
    def __init__(self, huts=None):
        ...
        self.cardPile = [SymbolCard("weaving", "food", 3), 
                         SymbolCard("weaving", "food", 1),
                         SymbolCard("time", "christmas", 0), 
                         SymbolCard("time", "foodTrack", 1),
                         SymbolCard("healing", "food", 5), 
                         SymbolCard("healing", "joker", 2),
                         SymbolCard("art", "tool", 1), 
                         SymbolCard("art", "roll", 6),
                         SymbolCard("pottery", "food", 7), 
                         SymbolCard("pottery", "christmas", 0), 
                         SymbolCard("transport", "stone", 2), 
                         SymbolCard("transport", "christmas", 0),
                         SymbolCard("music", "score", 3), 
                         SymbolCard("music", "score", 3),
                         SymbolCard("writing", "extraCard", 1), 
                         SymbolCard("writing", "christmas", 0),

...
if __name__ == '__main__':
    ...
    fifthSolution = 'print(max([(solutions5(p), p) for p in range(12, 1002, 2)]))'
    print(timeit.timeit(fifthSolution, setup='from __main__ import solutions5', number=rounds) / rounds)
